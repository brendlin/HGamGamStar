#ifndef HGamGamStar_ZyUnfoldingInput_H
#define HGamGamStar_ZyUnfoldingInput_H

#include "HGamAnalysisFramework/HgammaAnalysis.h"

class ZyUnfoldingInput : public HgammaAnalysis {
...
public:
  ...
  ZyUnfoldingInput() { }
  ZyUnfoldingInput(const char *name);
  virtual ~ZyUnfoldingInput();
  ...
  ClassDef(ZyUnfoldingInput, 1);
};

#endif // HGamGamStar_ZyUnfoldingInput_H
