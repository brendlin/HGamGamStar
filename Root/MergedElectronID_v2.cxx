...
//     double fSide = ele.showerShapeValue(xAOD::EgammaParameters::ShowerShapeType::fracs1);
    ...
    // 60-800 GeV - at 60% WP
     ...
     if((wTotS1>-100. && pte>60.000000 && pte<800.000000 && fabs(etae)>0.000000 && fabs(etae)<0.800000 && fabs(vtx_dphi)<0.020000 && fabs(vtx_deta)<0.010000)&&(Rhad<0.007920 && Eratio>0.825656 && Rphi>0.685707 && Reta>0.945474 && f3<0.03 && wEta2<0.010545 && wTotS1<4.803770 && trk_TRT_PID1>-0.048709 && trk_TRT_PID2>-0.271082 && EoP<1.996022 && trk_dEta1<0.003580)) return true;

     //signal efficiency: 12242/19675=0.622211
     //bkg efficiency: 80/70384=0.00113662
     if((wTotS1>-100. && pte>60.000000 && pte<800.000000 && fabs(etae)>0.800000 && fabs(etae)<1.370000 && fabs(vtx_dphi)<0.020000 && fabs(vtx_deta)<0.010000)&&(Rhad<0.010288 && Eratio>0.920766 && Rphi>0.660021 && Reta>0.935034 && f3<0.03 && wEta2<0.012633 && wTotS1<3.196767 && trk_TRT_PID1>-0.154170 && trk_TRT_PID2>-0.132265 && EoP<6.719277 && trk_dEta1<0.001038)) return true;
    ...
    if((wTotS1>-100. && pte>60.000000 && pte<8000.000000 && fabs(etae)>2.010000 && fabs(etae)<2.370000 && fabs(vtx_dphi)<0.020000 && fabs(vtx_deta)<0.010000)&&(Rhad<0.005030 && Eratio>0.902925 && Rphi>0.742276 && Reta>0.928840 && f3<0.03 && wEta2<0.015539 && wTotS1<1.783990 && trk_TRT_PID1>-100.000000 && trk_TRT_PID2>-100.000000 && EoP<6.231330 && trk_dEta1<0.001250)) return true;
    ...
    if((wTotS1>-100. && pte>50.000000 && pte<60.000000 && fabs(etae)>2.010000 && fabs(etae)<2.370000 && fabs(vtx_dphi)<0.020000 && fabs(vtx_deta)<0.010000)&&(Rhad<0.009297 && Eratio>0.514015 && Rphi>0.847031 && Reta>0.927671 && f3<0.03 && wEta2<0.012936 && wTotS1<2.191503 && trk_TRT_PID1>-100.000000 && trk_TRT_PID2>-100.000000 && EoP<2.105054 && trk_dEta1<0.003560)) return true;
    ...
    // 40-50 GeV
     ...
     if((wTotS1>-100. && pte>40.000000 && pte<50.000000 && fabs(etae)>0.000000 && fabs(etae)<0.800000 && fabs(vtx_dphi)<0.020000 && fabs(vtx_deta)<0.010000)&&(Rhad<0.008006 && Eratio>0.866114 && Rphi>0.362006 && Reta>0.931920 && f3<0.03 && wEta2<0.011536 && wTotS1<2.842709 && trk_TRT_PID1>-0.068432 && trk_TRT_PID2>-0.154553 && EoP<1.455041 && trk_dEta1<0.004640)) return true;

     //signal efficiency: 3288/6610=0.497428
     //bkg efficiency: 153/337512=0.000453317
     if((wTotS1>-100. && pte>40.000000 && pte<50.000000 && fabs(etae)>0.800000 && fabs(etae)<1.370000 && fabs(vtx_dphi)<0.020000 && fabs(vtx_deta)<0.010000)&&(Rhad<0.011777 && Eratio>0.806071 && Rphi>0.508373 && Reta>0.936448 && f3<0.03 && wEta2<0.011727 && wTotS1<3.917183 && trk_TRT_PID1>-0.081285 && trk_TRT_PID2>-0.159510 && EoP<5.202778 && trk_dEta1<0.000985)) return true;
    ...
    if((wTotS1>-100. && pte>40.000000 && pte<50.000000 && fabs(etae)>1.520000 && fabs(etae)<2.010000 && fabs(vtx_dphi)<0.020000 && fabs(vtx_deta)<0.010000)&&(Rhad<0.011486 && Eratio>0.927473 && Rphi>0.435598 && Reta>0.925742 && f3<0.03 && wEta2<0.012369 && wTotS1<3.661756 && trk_TRT_PID1>-0.011563 && trk_TRT_PID2>-0.417202 && EoP<5.788745 && trk_dEta1<0.001250)) return true;
    ...
    if((wTotS1>-100. && pte>40.000000 && pte<50.000000 && fabs(etae)>2.010000 && fabs(etae)<2.370000 && fabs(vtx_dphi)<0.020000 && fabs(vtx_deta)<0.010000)&&(Rhad<0.007800 && Eratio>0.960342 && Rphi>0.743595 && Reta>0.920413 && f3<0.03 && wEta2<0.012347 && wTotS1<1.411089 && trk_TRT_PID1>-100.000000 && trk_TRT_PID2>-100.000000 && EoP<2.369355 && trk_dEta1<0.001652)) return true;
    ...
    // changed to 45% WP
     ...
     if((wTotS1>-100. && pte>30.000000 && pte<40.000000 && fabs(etae)>0.000000 && fabs(etae)<0.800000 && fabs(vtx_dphi)<0.020000 && fabs(vtx_deta)<0.010000)&&(Rhad<0.018203 && Eratio>0.750413 && Rphi>0.378545 && Reta>0.939417 && f3<0.03 && wEta2<0.013086 && wTotS1<2.747719 && trk_TRT_PID1>-0.071126 && trk_TRT_PID2>-0.118842 && EoP<17.921568 && trk_dEta1<0.001160)) return true;

     //signal efficiency: 1537/3508=0.438141
     //bkg efficiency: 85/56006=0.00151769
     if((wTotS1>-100. && pte>30.000000 && pte<40.000000 && fabs(etae)>0.800000 && fabs(etae)<1.370000 && fabs(vtx_dphi)<0.020000 && fabs(vtx_deta)<0.010000)&&(Rhad<0.010903 && Eratio>0.820701 && Rphi>0.395608 && Reta>0.898833 && f3<0.03 && wEta2<0.012040 && wTotS1<2.792041 && trk_TRT_PID1>-0.099147 && trk_TRT_PID2>-0.049472 && EoP<14.419681 && trk_dEta1<0.001497)) return true;
    ...
    if((wTotS1>-100. && pte>30.000000 && pte<40.000000 && fabs(etae)>1.520000 && fabs(etae)<2.010000 && fabs(vtx_dphi)<0.020000 && fabs(vtx_deta)<0.010000)&&(Rhad<0.011385 && Eratio>0.890966 && Rphi>0.587361 && Reta>0.928949 && f3<0.03 && wEta2<0.012791 && wTotS1<5.512513 && trk_TRT_PID1>-0.088572 && trk_TRT_PID2>-0.074673 && EoP<2.245576 && trk_dEta1<0.002411)) return true;
    ...
    if((wTotS1>-100. && pte>30.000000 && pte<40.000000 && fabs(etae)>2.010000 && fabs(etae)<2.370000 && fabs(vtx_dphi)<0.020000 && fabs(vtx_deta)<0.010000)&&(Rhad<0.008061 && Eratio>0.871364 && Rphi>0.634550 && Reta>0.916855 && f3<0.03 && wEta2<0.012036 && wTotS1<1.487706 && trk_TRT_PID1>-100.000000 && trk_TRT_PID2>-100.000000 && EoP<2.079409 && trk_dEta1<0.001821)) return true;
    ...
    if((wTotS1>-100. && pte>20.000000 && pte<30.000000 && fabs(etae)>1.520000 && fabs(etae)<2.010000 && fabs(vtx_dphi)<0.030000 && fabs(vtx_deta)<0.010000)&&(Rhad<0.031010 && Eratio>0.921214 && Rphi>0.610367 && Reta>0.925299 && f3<0.03 && wEta2<0.013959 && wTotS1<3.378504 && trk_TRT_PID1>0.034933 && trk_TRT_PID2>-0.315406 && EoP<2.499431 && trk_dEta1<0.002653)) return true;
    ...
    if((wTotS1>-100. && pte>20.000000 && pte<30.000000 && fabs(etae)>2.010000 && fabs(etae)<2.370000 && fabs(vtx_dphi)<0.030000 && fabs(vtx_deta)<0.010000)&&(Rhad<0.026704 && Eratio>0.903645 && Rphi>0.678678 && Reta>0.919190 && f3<0.03 && wEta2<0.013965 && wTotS1<1.467929 && trk_TRT_PID1>-100.000000 && trk_TRT_PID2>-100.000000 && EoP<1.889961 && trk_dEta1<0.001359)) return true;
...
float HG::MergedElectronID_v2::GetScaleFactor(const xAOD::Electron &ele, MergedSystematic sys) const{
  ...
  static const std::vector<std::vector<float>> nominal_sf ({
      ...
      {      1,     1,   999,     1,     1}, // pT [20, 30] GeV
      {      1,     1,   999,     1,     1}, // pT [30, 40] GeV
      {      1,     1,   999,     1,     1}, // pT [40, 50] GeV
      {      1,     1,   999,     1,     1}  // pT [50, 100+] GeV
    });

  static const std::vector<std::vector<float>> stat_unc ({
      // 0-0.8,to1.37,to1.52,to2.01,to2.37
      {   0.05,  0.05,   999,  0.05,  0.05}, // pT [20, 30] GeV
      {   0.05,  0.05,   999,  0.05,  0.05}, // pT [30, 40] GeV
      {   0.05,  0.05,   999,  0.05,  0.05}, // pT [40, 50] GeV
      {   0.05,  0.05,   999,  0.05,  0.05}  // pT [50, 100+] GeV
    });

  static const std::vector<std::vector<float>> syst_unc ({
      // 0-0.8,to1.37,to1.52,to2.01,to2.37
      {   0.07,  0.07,   999,  0.07,  0.07}, // pT [20, 30] GeV
      {   0.07,  0.07,   999,  0.07,  0.07}, // pT [30, 40] GeV
      {   0.07,  0.07,   999,  0.07,  0.07}, // pT [40, 50] GeV
      {   0.07,  0.07,   999,  0.07,  0.07}  // pT [50, 100+] GeV
    });
